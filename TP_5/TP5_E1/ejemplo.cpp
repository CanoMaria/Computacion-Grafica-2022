...
void dibujar(void)
{
    //Limpia la ventana con el color blanco y aplicamos z-buffeers
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glLoadIdentity();
    gluLookAt(posX, posY, posZ, 0, 0, 0, 0, 1, 0);
    loadFile("pared_1.3vn","yellow1");
    loadFile("pared_2.3vn","yellow1");
    loadFile("piso.3vn","yellow2");
    loadFile("mesa.3vn","blue");
    loadFile("pelota.3vn","red");
    loadFile("silla.3vn","green");
